...
public class AddBook extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>, ZBarScannerView.ResultHandler {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView.findViewById(R.id.scan_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mScannerView.setResultHandler((ZBarScannerView.ResultHandler) getActivity().getSupportFragmentManager().findFragmentById(R.id.fragmentContainer1));
    ...
    /*
    Sets up loader. If book length is == 10 characters and it does not begin with "978" it will try to append
    "978" to the 10 digits and perform a search.
     */
    @Override
    ...
    public void handleResult(Result rawResult) {
        ...
        ean.setText(rawResult.getContents());
        //mScannerView.startCamera();
    }
